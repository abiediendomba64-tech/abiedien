...
def show_admin_panel(chat_id):
    ...
    markup.add(
        ...
        types.InlineKeyboardButton("🎨 Tema", callback_data="theme"),
        types.InlineKeyboardButton("🔑 Panel", callback_data="panel"),
        types.InlineKeyboardButton("📢 Pengumuman", callback_data="announce"),
